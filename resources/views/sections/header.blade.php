    ...
    <div class="flex items-center justify-between">
      ...
      <div class="max-sm:flex-wrap flex flex-row sm:flex-col sm:space-y-5 lg:space-y-7 justify-end">
        <div class="space-x-2.5 sm:space-x-30 flex items-center justify-end">
          <a href="mailto:biuro@brikol.pl" class="text-base text-color6 flex items-center space-x-2.5 group max-sm:bg-color4  max-sm:p-3 transition-all duration-500 max-sm:hover:bg-color2">
            ...
            <span class="transition-all duration-500 group-hover:text-color2 hidden sm:block">biuro@brikol.pl</span>
          </a>
          <a href="tel:{{ removeSpaces('+48 792 207 550') }}" class="text-base text-color6 flex items-center space-x-2.5 group max-sm:bg-color4 max-sm:p-3  transition-all duration-500 max-sm:hover:bg-color2">
            ...
            <span class="transition-all duration-500 group-hover:text-color2 hidden sm:block">+48 792 207 550</span>
          </a>
        </div>
        <div class="space-x-2.5 md:space-x-5 lg:space-x-30 xl:space-x-60 flex items-center justify-end">
          ...
          <div class="socials space-x-2.5 flex items-center justify-center">
            <a href="" class="group bg-color4 max-sm:p-3 p-4 flex items-center justify-center transition-all duration-500 hover:bg-color2">
