      ...
      <div class="flex flex-col space-y-7">
        <div class="space-x-30 flex items-center justify-end">
          ...
          <a href="tel:{{ removeSpaces('+48 792 207 550') }}" class="text-base text-color6 flex items-center space-x-2 5 group">
            ...
            <span class="transition-all duration-500 group-hover:text-color2">+48 792 207 550</span>
          </a>
        </div>
        <div class="space-x-30 lg:space-x-60 flex items-center">
          @if (has_nav_menu('primary_navigation'))
          <nav class="nav-primary" aria-label="{{ wp_get_nav_menu_name('primary_navigation') }}">
            {!! wp_nav_menu(['theme_location' => 'primary_navigation', 'menu_class' => 'nav uppercase text-menu flex items-center xl:space-x-60 space-x-30', 'echo' => false]) !!}
          </nav>
          @endif
          <div class="socials space-x-2.5 flex items-center justify-center">
            <a href="" class="group bg-color4 p-4 flex items-center justify-center transition-all duration-500 hover:bg-color2">
