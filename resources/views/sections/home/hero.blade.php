                ...
                <div class="swiper-slide">
                    <div class="row lg:grid flex flex-col lg:grid-cols-12 gap-5 grid-flow-col relative bg-white h-[600px]">
                        ...
                        <div class="col-span-9">
                            ...
                            <div class="triangle w-[calc((513.33/1600)*100%)] h-[600px] absolute bottom-0 bg-white z-[1] left-[calc((400/1600)*100%)]"></div>
                            <img class="right-0 absolute w-[calc((1200/1600)*100%)] bottom-0 h-[600px] object-cover object-right " src="{{ asset('images/home-hero-1.png') }}" alt="">
                        </div>
                    </div>
                </div>
